                        ...
                        <div class="btn-controls">
                            ...
                            <div class="btn-box-row row-fluid">
                                ...
                                <form class="mb-3" method="GET" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="from_date" name="from_date"
                                            ...
                                            onchange="handleChange(event, 'min')" required />
                                    </div>
                                    <div class="form-group">
                                        <label for="to_date">To</label>
                                        <input type="date" class="form-control" id="to_date" name="to_date"
                                            value="<?php if(isset($_GET['to_date'])) echo $_GET['to_date']; ?>"
                                            onchange="handleChange(event, 'max')" required />
                                    </div>
                                ...
                                // `category`, `productName`, `productPrice`
                                    $sql="SELECT *,(productPrice*quantity) as 'tot' FROM category c, `products` p,`orders` o WHERE c.id=p.category AND  p.id=`productId` AND orderStatus='Delivered' AND o.`orderDate` BETWEEN '$from_date' AND '$to_date'";
                                  $result =  mysqli_query($conn,$sql);
                                  while($row = mysqli_fetch_array($result)){
