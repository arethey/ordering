...
if(!isset($_SESSION['captcha'])){
	...
	$recaptcha = new \Recaptcha\Recaptcha('6Lf9aZAfAAAAAKVstejPOaQNOwSudA2AbpNFbLx3', new \Recaptcha\RequestMethod\SocketPost());
	$resp = $recaptcha->verify($_POST[''], $_SERVER['REMOTE_ADDR']);
	if (!$resp->isSuccess()){
		$_SESSION['errmsg'] = "Please answer recaptcha correctly";
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create your own Ordering account.</p>
...
<div class="form-group">
		...
		<?php
	  		if(!isset($_SESSION['captcha'])){
	  			echo '
	  				<div class="form-group">
	  					<div class="g-recaptcha" data-sitekey="6Lf9aZAfAAAAADo4v96fxSHKCCl1ni40WeUxuwEM"></div>
	  				</div>
	  			';
	  		}
	  	?>
